...
public class Employee extends BaseEntity{
     ...
     * @Builder.Default: Alanın default olarak nasıl atanacağını belirtiyoruz. ERole.EMPLOYEE diyerek statüsü belirtilmediyse EMPLOYEE olarak atanmasını sağlıyoruz.
     */
