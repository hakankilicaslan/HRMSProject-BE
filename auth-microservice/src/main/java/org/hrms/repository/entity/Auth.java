 ...
 * Hem miras alınan hem de miras alan sınıflar @SuperBuilder olarak işaretlenmelidir. Auth sınıfı BaseEntity'den miras aldığı için @Builder yerine @SuperBuilder anotasyonunu kullanmalıyız.
 *
 ...
 * name = "tbl_auth" diyerek veritabanında tbl_auth adında bir tablo oluşturur ve sınıfın verilerini o tabloya kaydeder ve bu tablodan veri çeker.
 */
...
public class Auth extends BaseEntity{
    ...
    @Builder.Default //@Builder.Default anotasyonu kullanarak eğer statüsü belirtilmediyse default olarak aşağıda belirttiğimiz gibi PENDING olarak atanmasını sağlıyoruz.
    private EStatus status = EStatus.ACTIVE;
    //private EStatus status = EStatus.PENDING; PENDING olduğunda giriş yapamadığımız için şimdilik metotları denemek için ACTIVE yaptık.
