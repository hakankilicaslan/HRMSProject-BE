 ...
 *
 * main metodumuzun içinde Spring Boot uygulamalarını başlatmak için kullanılan SpringApplication sınıfı üzerinden run metodunu cağırarak başlatılacak olan sınıfımızı veriyoruz.
