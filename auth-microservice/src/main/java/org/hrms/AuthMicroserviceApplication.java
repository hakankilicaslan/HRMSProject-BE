 ...
 *
 * main metodumuzun içinde Spring Boot uygulamalarını başlatmak için kullanılan SpringApplication sınıfı üzerinden run metodunu cagirarak baslatilacak olan sinifimizi veriyoruz
